...
import { AtSwipeActionProps, AtSwipeActionState, SwipeActionOption } from 'types/swipe-action'
...
import { delayGetClientRect, delayGetScrollOffset, isTest, uuid } from '../../common/utils'
...
export default class AtSwipeAction extends AtComponent<AtSwipeActionProps, AtSwipeActionState> {
  ...
  private domInfo: SelectorQuery.rectElement
